...
func (i *DryRun) Run(c *claim.Claim, creds valuesource.Set, opCfgs ...OperationConfigFunc) error {
	return (&RunCustom{Driver: i.Driver, Action: ActionDryRun}).Run(c, creds, opCfgs...)
}

// Run executes a help action in an image
func (i *Help) Run(c *claim.Claim, creds valuesource.Set, opCfgs ...OperationConfigFunc) error {
	return (&RunCustom{Driver: i.Driver, Action: ActionHelp}).Run(c, creds, opCfgs...)
}

// Run executes a log action in an image
func (i *Log) Run(c *claim.Claim, creds valuesource.Set, opCfgs ...OperationConfigFunc) error {
	return (&RunCustom{Driver: i.Driver, Action: ActionLog}).Run(c, creds, opCfgs...)
}

// Run executes a status action in an image
func (i *Status) Run(c *claim.Claim, creds valuesource.Set, opCfgs ...OperationConfigFunc) error {
